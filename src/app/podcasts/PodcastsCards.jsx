    ...
    <section className="my-20 w-[95%] mx-auto">
      ...
      <div className="">
        {podcasts.map((podcast, idx) => (
          <div
            key={podcast.id}
            className="flex flex-wrap items-center justify-between border-b py-10"
          >
            ...
            <div className="flex lg:flex-row flex-col lg:items-center gap-5 mt-5">
              <p className="text-md font-bold capitalize">
                date
                <Link href={"/podcasts"} className="font-normal ml-2">
                  {podcast.date}
                </Link>
              </p>
              ...
              <Link
                href={`podcasts/${podcast.id}`}
                className="hidden lg:flex uppercase font-bold text-sm items-center gap-2"
              >
                listen
                <FaArrowRight />
              </Link>
